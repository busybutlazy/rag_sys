...
namespace BeServer.Migrations
{
    ...
    [Migration("20260617152426_Phase19GraphExtractionStatus")]
    partial class Phase19GraphExtractionStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeServer.Data.Entities.IngestionJob", b =>
                {
                    ...
                    b.Property<string>("GraphExtractionStatus")
                        .HasMaxLength(16)
                        .HasColumnType("varchar(16)");
            ...
            modelBuilder.Entity("BeServer.Data.Entities.NotebookRetrievalVersion", b =>
                {
                    ...
                    b.Property<bool>("EnableGraph")
                        .HasColumnType("tinyint(1)");

                    b.Property<string>("GraphExtractionModel")
                        .HasMaxLength(128)
                        .HasColumnType("varchar(128)");

                    b.Property<int>("MaxFactHits")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(8);

                    b.Property<int>("MaxGraphHops")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1);
